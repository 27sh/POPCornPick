...
<body>
    <main>
        <div id="cinemaList">
            <select id="cinemaLocation" name="cinemaLocation" required></select>
            <select name="cinemaName" id="cinemaName"></select>
        </div>
                    ...
                    rooms.forEach(function (room) {
                        ...
                        $.ajax({
                            ...
                            success: function (schedule) {
                                ...
                                // 해당 관람관의 일정을 표시할 캘린더 선택
                                var calendarClass;
                                if (room.roomType.bigType === "일반관") {
                                    calendarClass = '.source-calendar';
                                } else if (room.roomType.bigType === "특별관") {
                                    calendarClass = '.destination-calendar';
                                } else {
                                    // 기본값 설정
                                    calendarClass = '.default-calendar';
                                }

                                // FullCalendar에 events 설정
                                var calendarEl = document.querySelector(calendarClass);

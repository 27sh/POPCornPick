																...
																data
																		.forEach(function(
																			...
																			var row = '<tr>'
																					...
																					+ faq.faqCategory
																					+ '</td>'
																					+ "<td><a href='/admin/noticeDetail/" + faq.noticeNo + "'>"
																					+ faq.faqTitle
																					+ "</a></td>"
																					+ '<td>'
																					+ formattedDate
			...
			$.ajax({
				...
				success : function(data) {
					...
					data.content.forEach(function(not) {
						...
						var month = (date.getMonth() + 1).toString().padStart(
								2, '0');
						var day = date.getDate().toString().padStart(2, '0');
						var formattedDate = year + '-' + month + '-' + day;

						var row = '<tr>' + '<td>' + counter + '</td>' + '<td>'
								+ not.faqCategory + '</td>' + "<td>"
								+ not.faqTitle + "</a></td>" + '<td>'
								+ formattedDate + '</td>' + '</tr>';
					...
					for (var i = 1; i <= totalPages; i++) {
						...
						pagination.append('<button class="' + buttonClass

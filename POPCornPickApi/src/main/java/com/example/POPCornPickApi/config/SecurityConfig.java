    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/", "/api/v1/common/**", "/api/v1/main/**", "/api/v1/memberCinema/**", "/api/v1/reservation/**", "/api/v1/schedule/**", "/api/v1/myPage/**", "/api/v1/film/**", "/api/v1/admin/**", "/api/v1/member/**", "/api/v1/memInquiry/**", "api/v1/event/**", "api/v1/sRoom/**").permitAll()

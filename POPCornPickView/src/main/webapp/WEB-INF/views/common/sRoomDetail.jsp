...
.theater-header .theater-image {
	...
	color: #fff;
	position: relative;
	box-shadow: inset 700px 0px 80px -20px rgba(0, 0, 0, 0.9), inset -700px 0 80px -20px rgba(0, 0, 0, 0.9);
    ...
    function handleTabClick(tabText) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var html = '<table class="branch-table">';
        ...
        $.ajax({
            url: 'http://localhost:9001/api/v1/sRoom/findMoviesByRoomType', // 새로운 기능 URL
            type: 'GET',
            data: { smallType: value },
            success: function(response) {
	...
	<main>
		<section class="schedule">
			...
			<div class="schedule-content">
				<div class="theater-image-slider">
					<div class="slider-image" style="background-image: url('/img/imaxSRoomImg.jpg');">ㅤ</div>
				</div>
			</div>
		</section>
		...
		<section class="theater-description">
				<div class="mini-context-box" id="context-box-1">
					...
					<div class="context-explane">Customized Projector로<br>비교할 수 없는 밝음과
						뛰어난<br>선명한 화질 제공</div>
				</div>
				<div class="mini-context-box" id="context-box-2">
					...
					<div class="context-explane">대형 스크린에 맞는<br>
						맞춤형 설계로 모든 좌석에서<br>
						최고의 몰입 가능</div>
				</div>
				<div class="mini-context-box" id="context-box-2">
					...
					<div class="context-explane">완벽하게 조율된 소리와<br>
						핀 포인트 정확도로<br>
						최적의 사운드를 제공</div>
				</div>
		</section>

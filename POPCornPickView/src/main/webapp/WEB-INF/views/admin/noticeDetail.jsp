...
<body>
	<main>
		...
		<div class="container" id="noticeDetail"></div>
	</main>
		...
		$(document)
				.ready(
						function() {
							...
							$
									.ajax({
										url : "http://localhost:9001/api/v1/admin/announcementDetial/"
												+ noticeNo,
										method : "GET",
										success : function(data) {
											console.log(data.noticeContent);
											let str = '';
											str += '<div>' + data.noticeFile
													+ '</div>';
											...
											str += '<textarea id="content" name="content" required>'
													+ data.noticeContent
													+ '</textarea>';
											str += '<hr>';
